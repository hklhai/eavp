package cn.edu.ncut.eavp.common.basedao;
...
public interface Dao<T  extends Serializable> {
	 ...
	 *            排序属性 value asc/desc
	 */
	public abstract List<T> findAll(String where, Map<String, ?> params,
	 ...
	 *            需要查询的字段
	 */
	public abstract QueryResult<Map<String, Object>> getScrollData(int firstResult,
	 ...
	 *            order by 属性  asc/desc
	 */
	public abstract QueryResult<T> getScrollData(int firstResult,
			int maxResult, String where, Map<String, Object> params,
			String orderby);
